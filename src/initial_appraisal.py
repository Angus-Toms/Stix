...
class InitialAppraisal(QWidget):
    ...
    def save_error(self, e: Exception) -> None:
        """ Display traceback of error incurred during appraisal write
...
class EditFloodDetails(QDialog):
    ...
    def __init__(self, parent: InitialAppraisal, db: InitialDataHandler) -> None:
        """
        Args:
            parent (InitialAppraisal): Appraisal widget that dialog box is being called from
            db (InitialDataHandler): Data handling class of current initial appraisal
        """
