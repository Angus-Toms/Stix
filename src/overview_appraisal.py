...
class EntryTab(QWidget):
    """ UI widget for the entry tab of the overview appraisal
    """
    def __init__(self, parent: OverviewAppraisal, db: OverviewDataHandler) -> None:
        """
        Args:
            parent (OverviewAppraisal): Appraisal which tab is placed into
            db (OverviewDataHandler): Data handling class of current appraisal
        """
        super().__init__()
        self.parent = parent
        self.db = db
...
class ResultsTab(QWidget):
    """ UI widget for the results tab of the overview appraisal
    """
    def __init__(self, parent: OverviewAppraisal, db: OverviewDataHandler) -> None:
        """_summary_
...
class EditFloodDetails(QDialog):
    ...
    def __init__(self, parent: EntryTab, db: OverviewDataHandler) -> None:
        """
        Args:
            parent (EntryTab): Entry tab that dialog box is being called from
            db (OverviewDataHandler): Data handling class of current appraisal
        """
...
class ResultsBreakdown(QDialog):
    """ UI widget for the results breakdown dialog box
    """
...
class ExportResults(QDialog):
    ...
    def __init__(self, parent: OverviewAppraisal) -> None:
        """ 
        Args:
            parent (OverviewAppraisal): Appraisal thay dialog box is being called from
        """
        super().__init__(parent)
        self.parent = parent
