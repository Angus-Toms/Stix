...
class Triton(QMainWindow):
    ...
    def init_menu_bar(self) -> None:
        ...
        help_action = QAction("Triton Help", self)
    ...
    def select_page(self, index: int) -> None:
        ...
        # Update window title
        page_titles = {
            0: "Triton v2.0.1 - Home",
            1: "Triton v2.0.1 - Appraisal Selection",
            2: "Triton v2.0.1 - Initial Appraisal",
            3: "Triton v2.0.1 - Overview Appraisal",
            4: "Triton v2.0.1 - Detailed Appraisal"
        }
    ...
    def new_appraisal_action(self, appraisal_level: QAction) -> None:
        """
        Start new appraisals from MenuBar action
        """
    ...
    def open_appraisal_action(self) -> None:
        """
        Open appraisal from MenuBar action
        """
        # Ask for confirmation if appraisal is already in process
        if self.stack.currentIndex() > 2:
            msgbox = QMessageBox(self)
...
def main() -> None:
    ...
    app.setWindowIcon(QIcon(get_resource_path("assets/triton.png")))

    triton = Triton()
    triton.showMaximized()
